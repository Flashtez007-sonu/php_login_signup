...
if (isset($_POST['subforgot'])) {
    ...
    if ($result) {
        ...
        if ($inresult) {
            $FromName = "flashtez007";
            $FromEmail = "no_reply@sonuguptasah96@gmail.com";
            $ReplyTo = "sonuguptasah96@gmail.com";
            $credits = "All rights are reserved | flashtez007 ";
            ...
            $msg = "Your password reset link <br> http://127.0.0.1/form1/password-reset.php?token=" . $token . " <br> Reset your password with this link .Click or open in new tab<br><br> <br> <br> <center>" . $credits . "</center>";
