            ...
            <div class="col-sm-4">
                ...
                if (isset($_POST['sub_set'])) {
                    ...
                    if (!isset($error)) {
                        ...
                        if ($resultresetpass) {
                            $success = "<div class='successmsg'><span style='font-size:100px;'>&#9989;</span> <br> Your password has been updated successfully.. 
                            <br> <a href='index.php' style='color:#fff;'>Login here... </a> </div>";
                ...
                <div class="login_form">
                    <form action="" method="POST">
                        <div class="form-group">
                            <img src="logo5.png" alt="flashtez007" class="logo img-fluid">
                            <?php
                            if (isset($error)) {
